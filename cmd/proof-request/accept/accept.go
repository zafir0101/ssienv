...
var (
	...
	AcceptCmd = &cobra.Command{
		Use:   "accept",
		Short: "Accept a proof request and store the presentation id on your controller",
...
func init() {
	AcceptCmd.Flags().StringVarP(&proofReqLabel, "label", "l", "", "the label that will identify the proof request on your controller (required)")
